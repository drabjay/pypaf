...
class TestExceptionII(unittest.TestCase):
    ...
    def test_list(self):
        ...
        self.assertEqual(
            ...
            "Incorrect Exception II list format"
            )
    ...
    def test_string(self):
        ...
        self.assertEqual(
            ...
            "Incorrect Exception II string format"
            )
    ...
    def test_tuple(self):
        ...
        self.assertEqual(
            ...
            "Incorrect Exception II tuple format"
            )
    ...
    def test_dict(self):
        ...
        self.assertEqual(
            ...
            "Incorrect Exception II dict format"
            )
    ...
    def test_premises(self):
        ...
        self.assertEqual(
            ...
            "Incorrect Exception II premises"
            )
